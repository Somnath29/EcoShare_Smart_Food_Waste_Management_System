                ...
                {list.map((item, idx) => (
                  <motion.div
                    ...
                    className={`px-3 py-1.5 border text-xs font-bold rounded-xl transition-all shadow-sm ${
                      idx === highlightIdx ? 'border-amber-400 bg-amber-400/10 text-amber-500' : 'border-emerald-500/20 bg-emerald-50/5 text-emerald-600 dark:text-emerald-400'
                    }`}
                  >
                    {item}
                  </motion.div>
          ...
          <div className="border-t border-zinc-200/80 dark:border-zinc-800/60 pt-4 flex flex-col sm:flex-row items-center justify-between gap-4 mt-4">
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-2 bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-955 rounded-xl shadow-md hover:scale-105 active:scale-95 transition-all cursor-pointer"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-455 mt-0.5 leading-tight">{algo.desc}</p>
                    </div>
                  </div>
                  <span 
                    onClick={(e) => {
            ...
            <div className="space-y-4">
              ...
              <div className="h-48 bg-zinc-50 dark:bg-zinc-950/40 border border-zinc-150 dark:border-zinc-850 rounded-2xl flex flex-col justify-center items-center p-6 relative overflow-hidden">
                ...
                <div className="absolute bottom-4 left-0 right-0 text-center">
                  <span className="text-[10px] font-bold text-zinc-550 dark:text-zinc-400 px-3 py-1 bg-zinc-200/50 dark:bg-zinc-850/50 border border-zinc-300 dark:border-zinc-850 rounded-full select-none">
    ...
    <div className="space-y-8 animate-fade-in">
        ...
        <div className="lg:col-span-8 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-xs text-zinc-550 dark:text-zinc-400">Chronological volumes logged by campus dining kitchens.</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
          ...
          <p className="text-xs text-zinc-550 dark:text-zinc-400 mb-6">Comparison volume ratios of meals rescued vs meals discarded.</p>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
          ...
          <p className="text-xs text-zinc-550 dark:text-zinc-400 mb-6">Metrics tracking active dispatches efficiencies indices.</p>
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
        ...
        <p className="text-xs text-zinc-550 dark:text-zinc-400 mb-6">Chronological tracking of carbon emissions prevented (kg CO2e).</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
          ...
          <p className="text-xs text-zinc-550 dark:text-zinc-400 mb-6">Proportional weights density mapping categories.</p>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 flex flex-col justify-between shadow-sm">
          <div>
            ...
            <p className="text-xs text-zinc-550 dark:text-zinc-400">Distribution of rescued food categories.</p>
          </div>
